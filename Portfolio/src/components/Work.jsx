...
const Work = () => {
    const [projects, setProjects] = useState([
        ...
        {'id' : 2, 'title' : 'TarotReader', 'description': 'An AI powered tarot reading web app', 'link': 'https://tarotreaderfe.vercel.app/', 'image': "/img_files/tarotReader_bg.png" },
        ...
        <div className='flex flex-wrap px-10 py-5 size-11/12 place-center justify-center' >
            <div className="flex flex-wrap h-full justify-around items-center">
                ...
                projects.map(project => (
                    ...
                    <div className={`p-2 my-1 h-48 `}>
                        <img src={project.image} alt="AgoraStore image" className="w-full h-full object-cover hover:border-4 hover:border-orange-600"/>
                    </div>
